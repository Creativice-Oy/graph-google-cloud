...
| `google_cloud_api_service`                                       | **HAS**               | `google_app_engine_application`                                   |
| `google_cloud_api_service`                                       | **HAS**               | `google_app_engine_service`                                       |
| `google_cloud_api_service`                                       | **HAS**               | `google_app_engine_version`                                       |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigquery_dataset`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigquery_table`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigtable_app_profile`                                     |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigtable_backup`                                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigtable_cluster`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigtable_instance`                                        |
| `google_cloud_api_service`                                       | **HAS**               | `google_bigtable_table`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_billing_account`                                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_backend_bucket`                                   |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_backend_service`                                  |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_disk`                                             |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_firewall`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_health_check`                                     |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_image`                                            |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_instance`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_instance_group`                                   |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_network`                                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_project`                                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_snapshot`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_ssl_policy`                                       |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_subnetwork`                                       |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_target_http_proxy`                                |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_target_https_proxy`                               |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_target_ssl_proxy`                                 |
| `google_cloud_api_service`                                       | **HAS**               | `google_compute_url_map`                                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_container_cluster`                                        |
| `google_cloud_api_service`                                       | **HAS**               | `google_container_node_pool`                                      |
| `google_cloud_api_service`                                       | **HAS**               | `google_dataproc_cluster`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_dns_managed_zone`                                         |
| `google_cloud_api_service`                                       | **HAS**               | `google_dns_policy`                                               |
| `google_cloud_api_service`                                       | **HAS**               | `google_cloud_folder`                                             |
| `google_cloud_api_service`                                       | **HAS**               | `google_cloud_function`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_iam_role`                                                 |
| `google_cloud_api_service`                                       | **HAS**               | `google_iam_service_account`                                      |
| `google_cloud_api_service`                                       | **HAS**               | `google_iam_service_account_key`                                  |
| `google_cloud_api_service`                                       | **HAS**               | `google_kms_crypto_key`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_kms_key_ring`                                             |
| `google_cloud_api_service`                                       | **HAS**               | `google_logging_metric`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_logging_project_sink`                                     |
| `google_cloud_api_service`                                       | **HAS**               | `google_memcache_instance`                                        |
| `google_cloud_api_service`                                       | **HAS**               | `google_monitoring_alert_policy`                                  |
| `google_cloud_api_service`                                       | **HAS**               | `google_cloud_organization`                                       |
| `google_cloud_api_service`                                       | **HAS**               | `google_privateca_certificate_authority`                          |
| `google_cloud_api_service`                                       | **HAS**               | `google_cloud_project`                                            |
| `google_cloud_api_service`                                       | **HAS**               | `google_pubsub_subscription`                                      |
| `google_cloud_api_service`                                       | **HAS**               | `google_pubsub_topic`                                             |
| `google_cloud_api_service`                                       | **HAS**               | `google_redis_instance`                                           |
| `google_cloud_api_service`                                       | **HAS**               | `google_cloud_run_service`                                        |
...
| `google_iam_binding`                                             | **ALLOWS**            | `google_app_engine_application`                                   |
| `google_iam_binding`                                             | **ALLOWS**            | `google_app_engine_service`                                       |
| `google_iam_binding`                                             | **ALLOWS**            | `google_app_engine_version`                                       |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigquery_dataset`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigquery_table`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigtable_app_profile`                                     |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigtable_backup`                                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigtable_cluster`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigtable_instance`                                        |
| `google_iam_binding`                                             | **ALLOWS**            | `google_bigtable_table`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_billing_account`                                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_api_service`                                        |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_folder`                                             |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_function`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_organization`                                       |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_project`                                            |
| `google_iam_binding`                                             | **ALLOWS**            | `google_cloud_run_service`                                        |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_backend_bucket`                                   |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_backend_service`                                  |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_disk`                                             |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_firewall`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_health_check`                                     |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_image`                                            |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_instance`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_instance_group`                                   |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_network`                                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_project`                                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_snapshot`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_ssl_policy`                                       |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_subnetwork`                                       |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_target_http_proxy`                                |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_target_https_proxy`                               |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_target_ssl_proxy`                                 |
| `google_iam_binding`                                             | **ALLOWS**            | `google_compute_url_map`                                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_container_cluster`                                        |
| `google_iam_binding`                                             | **ALLOWS**            | `google_container_node_pool`                                      |
| `google_iam_binding`                                             | **ALLOWS**            | `google_dataproc_cluster`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_dns_managed_zone`                                         |
| `google_iam_binding`                                             | **ALLOWS**            | `google_dns_policy`                                               |
| `google_iam_binding`                                             | **ALLOWS**            | `google_kms_crypto_key`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_kms_key_ring`                                             |
| `google_iam_binding`                                             | **ALLOWS**            | `google_logging_metric`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_logging_project_sink`                                     |
| `google_iam_binding`                                             | **ALLOWS**            | `google_memcache_instance`                                        |
| `google_iam_binding`                                             | **ALLOWS**            | `google_monitoring_alert_policy`                                  |
| `google_iam_binding`                                             | **ALLOWS**            | `google_privateca_certificate_authority`                          |
| `google_iam_binding`                                             | **ALLOWS**            | `google_pubsub_subscription`                                      |
| `google_iam_binding`                                             | **ALLOWS**            | `google_pubsub_topic`                                             |
| `google_iam_binding`                                             | **ALLOWS**            | `google_redis_instance`                                           |
| `google_iam_binding`                                             | **ALLOWS**            | `google_iam_role`                                                 |
| `google_iam_binding`                                             | **ALLOWS**            | `google_iam_service_account`                                      |
